...
blockParticleFilter <- function(N, n, blocks, fParams, gParams, resampling = TRUE) {
    .Call('_SMC5_blockParticleFilter', PACKAGE = 'SMC5', N, n, blocks, fParams, gParams, resampling)
}

sequentialImportanceSampling <- function(N, n, fParams, gParams) {
    .Call('_SMC5_sequentialImportanceSampling', PACKAGE = 'SMC5', N, n, fParams, gParams)
}

bootstrapParticleFilter <- function(N, n, fParams, gParams) {
    .Call('_SMC5_bootstrapParticleFilter', PACKAGE = 'SMC5', N, n, fParams, gParams)
}

KalmanFilterCpp <- function(m_0, C_0, F_matrix, G, V, W, y) {
    .Call('_SMC5_KalmanFilterCpp', PACKAGE = 'SMC5', m_0, C_0, F_matrix, G, V, W, y)
}

KalmanSmoothingCpp <- function(m_0, C_0, F_matrix, G, V, W, y) {
    .Call('_SMC5_KalmanSmoothingCpp', PACKAGE = 'SMC5', m_0, C_0, F_matrix, G, V, W, y)
}

KalmanSamplerCpp <- function(n, kalmanRes, time) {
    .Call('_SMC5_KalmanSamplerCpp', PACKAGE = 'SMC5', n, kalmanRes, time)
}
...
dmvnrmArma <- function(x, mean, sigma, logd = FALSE, diag = FALSE) {
    .Call('_SMC5_dmvnrmArma', PACKAGE = 'SMC5', x, mean, sigma, logd, diag)
}

dnrmArma <- function(x, mean, sigma, logd = FALSE) {
    .Call('_SMC5_dnrmArma', PACKAGE = 'SMC5', x, mean, sigma, logd)
}
...
mvrnormArma <- function(n, mean, sigma, diag = FALSE) {
    .Call('_SMC5_mvrnormArma', PACKAGE = 'SMC5', n, mean, sigma, diag)
}

rnormArma <- function(n, mean, sigma) {
    .Call('_SMC5_rnormArma', PACKAGE = 'SMC5', n, mean, sigma)
}

logAddition <- function(x, y) {
    .Call('_SMC5_logAddition', PACKAGE = 'SMC5', x, y)
}

logAdditionSum <- function(x) {
    .Call('_SMC5_logAdditionSum', PACKAGE = 'SMC5', x)
}

ProbSampleReplace <- function(nOrig, size, prob) {
    .Call('_SMC5_ProbSampleReplace', PACKAGE = 'SMC5', nOrig, size, prob)
}

checkDiagonal <- function(X) {
    .Call('_SMC5_checkDiagonal', PACKAGE = 'SMC5', X)
}

checkSymmetric <- function(X) {
    .Call('_SMC5_checkSymmetric', PACKAGE = 'SMC5', X)
}
